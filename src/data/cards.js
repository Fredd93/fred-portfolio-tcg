...
// Jericho/PORTFOLIO.md, and the TulipVision handoff doc. HP = estimated work
// hours, always labeled "est." in the UI — it is a stylization, not a logged metric.
...
export const PROJECTS = [
  {
    ...
    stage: 'Stage 2 · In Progress', hp: 180, icon: '🛰️',
    attacks: [
    ...
    weakness: 'Scope creep ×2', resistance: 'Build-ahead −20 (deferred to Sprint 7+)', retreat: 2,
  ...
  },
  {
    ...
    stage: 'Stage 1 · Internship', hp: 650, icon: '⛈️',
    attacks: [
    ...
    weakness: '—', resistance: 'Latency −30 (Redis cache)', retreat: 1,
  ...
  },
  {
    ...
    stage: 'Stage 2 · Deployed', hp: 240, icon: '🌷',
    attacks: [
    ...
    weakness: 'Team scope ×2 (3-person academic project)', resistance: 'Downtime −40 (graceful fallbacks everywhere)', retreat: 2,
  ...
  },
  {
    ...
    stage: 'Stage 1 · Primary Dev', hp: 200, icon: '🚗',
    attacks: [
  ...
  },
  {
    ...
    stage: 'Stage 1 · Design Lead', hp: 90, icon: '🎪',
    attacks: [
